...
def main():
    ...
    '''
    parser = argparse.ArgumentParser(description="Benchmarking script for Swin Transformer model")
    ...
    model_states_dir = f"experiments/states/swin/{dataset_name}"
    ...
    for run in range(n_runs):
        ...
        logger = TensorBoardLogger('experiments/logs', name=f'swin/{dataset_name}')
        ...
        best_model = Swin.load_from_checkpoint(checkpoint.best_model_path, config=config)
